    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 text-center">
                <legend class="display-1">Article display</legend>
                <p class="lead display-3"><span class="display-4">Title od article:</span><?php echo $articles->title; ?></p>
                <p class="lead display-3"><span class="display-4">Title description:</span><?php echo $articles->description; ?></p>
